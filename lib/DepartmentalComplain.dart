...
import 'package:learning/DepartmentalComplainDetail.dart';
import 'package:learning/DepartmentalComplainModal.dart';
import 'package:learning/MyComplainDetail.dart';
import 'package:shared_preferences/shared_preferences.dart';

class DepartmentalComplain extends StatefulWidget {
  @override
  _DepartmentalComplainState createState() => _DepartmentalComplainState();
}

class _DepartmentalComplainState extends State<DepartmentalComplain> {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text("My Departmental Complains"),
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => DepartmentalComplainDetail(
                          id: list[index].id,
  ...
  Future complainList() async {
    ...
    final queryParameters = {
      'department_id': prefs.getString("department").toString(),
    };
    final response =
    await http.post(Uri.parse(ticket_department_list), body: queryParameters);
    print(response.body);
    if (response.statusCode == 200) {
      ...
      list = rest
          .map<DepartmentalComplainModal>((json) => DepartmentalComplainModal.fromJson(json))
          .toList();
      setState(() {});
    } else {
      EasyLoading.dismiss();
