...
class FacilityAdd extends StatefulWidget {
  @override
  _FacilityAddState createState() => _FacilityAddState();
}

class _FacilityAddState extends State<FacilityAdd> {
  ...
  Future updateApi() async {
    ...
    final response =
    await http.post(Uri.parse(facilites_register), body: queryParameters);
    print(response.body);
