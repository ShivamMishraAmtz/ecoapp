...
class DepartmentalComplainDetail extends StatefulWidget {
  final int id;
  ...
  @override
  _DepartmentalComplainDetailState createState() =>
      _DepartmentalComplainDetailState(
        id: id,
...
class _DepartmentalComplainDetailState
    extends State<DepartmentalComplainDetail> {
  final int id;
  final int complaints_user;
  final int company_id;
  final int department_id;
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text("Department Complain Detail"),
